(ns propagation.advisor
  "PropagationAdvisor -- the LLM/decision-maker that proposes operations.

  The advisor operates purely at the proposal level; the Governor
  (propagation.governor) independently validates all proposals against
