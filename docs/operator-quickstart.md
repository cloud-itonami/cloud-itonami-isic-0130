# Operator Quickstart — Plant Propagation Nursery Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0130** (`cloud-itonami-isic-0130`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0130.git
cd cloud-itonami-isic-0130
```
...
- Blueprint governor key: `nursery-operations-governor`
- Likely source path: `propagation.governor.cljc`
